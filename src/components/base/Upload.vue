...
<template>
    <div v-if="!img" class="upload_wrap" @drop.prevent.stop="handleDrop" @dragover.prevent.stop="handleDragOver" @dragleave.prevent.stop="handleDragLeave" @click="handleClick">
        <input ref="fileInput" type="file" style="display: none" accept=".jpg,.jpeg,.png,.gif" @change="handleChange" />
        <p>+</p>
    </div>
